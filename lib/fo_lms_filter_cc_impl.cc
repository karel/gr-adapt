...
#include "fo_lms_filter_cc_impl.h"
...
fo_lms_filter_cc::sptr fo_lms_filter_cc::make(double samp_rate,
                                              int num_taps,
                                              float mu_cir,
                                              float mu_cfo,
                                              float mu_sfo,
                                              ...
                                              bool reset)
{
    return gnuradio::make_block_sptr<fo_lms_filter_cc_impl>(
 ...
 */
fo_lms_filter_cc_impl::fo_lms_filter_cc_impl(double samp_rate,
                                             int num_taps,
                                             float mu_cir,
                                             float mu_cfo,
                                             float mu_sfo,
...
fo_lms_filter_cc_impl::~fo_lms_filter_cc_impl() { delete[] d_y; }

float fo_lms_filter_cc_impl::get_mu_cir() const { return d_mu_cir; }

void fo_lms_filter_cc_impl::set_mu_cir(float mu_cir) { d_mu_cir = mu_cir; }

float fo_lms_filter_cc_impl::get_mu_cfo() const { return d_mu_cfo; }

void fo_lms_filter_cc_impl::set_mu_cfo(float mu_cfo) { d_mu_cfo = mu_cfo; }

float fo_lms_filter_cc_impl::get_mu_sfo() const { return d_mu_sfo; }

void fo_lms_filter_cc_impl::set_mu_sfo(float mu_sfo) { d_mu_sfo = mu_sfo; }

bool fo_lms_filter_cc_impl::get_adapt() const { return d_adapt; }

void fo_lms_filter_cc_impl::set_adapt(bool adapt) { d_adapt = adapt; }

bool fo_lms_filter_cc_impl::get_reset() const { return d_reset; }

void fo_lms_filter_cc_impl::set_reset(bool reset)
{
    d_reset = reset;
    if (d_reset) {
...
gr_complex fo_lms_filter_cc_impl::error(const gr_complex& desired, const gr_complex& out)
{
    return desired - out;
}

void fo_lms_filter_cc_impl::update_tap(gr_complex& tap, const gr_complex& in)
{
...
int fo_lms_filter_cc_impl::general_work(int noutput_items,
