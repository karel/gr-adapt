...
#ifndef INCLUDED_ADAPT_RLS_FILTER_FF_IMPL_H
#define INCLUDED_ADAPT_RLS_FILTER_FF_IMPL_H

#include "config.h"
#ifdef ARMADILLO_FOUND
#include <armadillo>
#endif
#include <gnuradio/adapt/rls_filter_ff.h>
#include <gnuradio/filter/fir_filter.h>

namespace gr {
namespace adapt {

class rls_filter_ff_impl : public rls_filter_ff, filter::kernel::fir_filter_fff
{
private:
    void init_internals();
    ...
    std::vector<std::vector<float>> d_P;
...
public:
    rls_filter_ff_impl(bool first_input,
                       int num_taps,
                       float delta,
                       float lambda,
                       unsigned skip,
...
#endif /* INCLUDED_ADAPT_RLS_FILTER_FF_IMPL_H */
