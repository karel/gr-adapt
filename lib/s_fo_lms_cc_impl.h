...
#ifndef INCLUDED_ADAPT_S_FO_LMS_CC_IMPL_H
#define INCLUDED_ADAPT_S_FO_LMS_CC_IMPL_H
...
class s_fo_lms_cc_impl : public s_fo_lms_cc, filter::kernel::fir_filter_ccc {
    private:
    ...
    float d_delta_x = 1.0;
    std::vector<std::vector<float>> d_C{
    ...
    public:
    s_fo_lms_cc_impl(double samp_rate,
                     int num_taps,
                     float mu_cir,
                     float mu_cfo,
                     float mu_sfo,
...
#endif /* INCLUDED_ADAPT_S_FO_LMS_CC_IMPL_H */
