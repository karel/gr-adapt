...
#ifndef INCLUDED_ADAPT_LMS_FILTER_CC_IMPL_H
#define INCLUDED_ADAPT_LMS_FILTER_CC_IMPL_H
...
public:
    lms_filter_cc_impl(bool first_input,
                       int num_taps,
                       float mu,
                       unsigned skip,
                       unsigned decimation,
...
#endif /* INCLUDED_ADAPT_LMS_FILTER_CC_IMPL_H */
