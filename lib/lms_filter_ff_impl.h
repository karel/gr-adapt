...
#ifndef INCLUDED_ADAPT_LMS_FILTER_FF_IMPL_H
#define INCLUDED_ADAPT_LMS_FILTER_FF_IMPL_H
...
class lms_filter_ff_impl : public lms_filter_ff, filter::kernel::fir_filter_fff
{
private:
#ifdef ARMADILLO_FOUND
    arma::fvec d_taps;
...
public:
    lms_filter_ff_impl(bool first_input,
                       int num_taps,
                       float mu,
                       unsigned skip,
                       unsigned decimation,
...
#endif /* INCLUDED_ADAPT_LMS_FILTER_FF_IMPL_H */
