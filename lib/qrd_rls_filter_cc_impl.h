...
#ifndef INCLUDED_ADAPT_QRD_RLS_FILTER_CC_IMPL_H
#define INCLUDED_ADAPT_QRD_RLS_FILTER_CC_IMPL_H
...
class qrd_rls_filter_cc_impl : public qrd_rls_filter_cc, filter::kernel::fir_filter_ccc
{
private:
    void init_internals();
...
public:
    qrd_rls_filter_cc_impl(int num_taps,
                           float delta,
                           float lambda,
                           unsigned skip,
                           unsigned decimation,
                           bool adapt,
                           bool reset);
    ~qrd_rls_filter_cc_impl() = default;
...
#endif /* INCLUDED_ADAPT_QRD_RLS_FILTER_CC_IMPL_H */
