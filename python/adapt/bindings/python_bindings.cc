...
PYBIND11_MODULE(adapt_python, m)
{
    ...
    bind_lms_filter_ff(m);
    bind_lms_filter_cc(m);
    bind_nlms_filter_ff(m);
    bind_nlms_filter_cc(m);
    bind_rls_filter_ff(m);
    bind_rls_filter_cc(m);
    bind_qrd_rls_filter_ff(m);
    bind_qrd_rls_filter_cc(m);
    bind_iqrd_rls_filter_ff(m);
    bind_iqrd_rls_filter_cc(m);
    bind_fo_lms_filter_cc(m);
    bind_s_fo_lms_filter_cc(m);
