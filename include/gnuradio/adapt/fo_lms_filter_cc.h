...
#ifndef INCLUDED_ADAPT_FO_LMS_FILTER_CC_H
#define INCLUDED_ADAPT_FO_LMS_FILTER_CC_H
 ...
 *
 */
class ADAPT_API fo_lms_filter_cc : virtual public gr::block
{
protected:
...
public:
    typedef std::shared_ptr<fo_lms_filter_cc> sptr;
...
#endif /* INCLUDED_ADAPT_FO_LMS_FILTER_CC_H */
