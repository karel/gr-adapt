...
#ifndef INCLUDED_ADAPT_S_FO_LMS_FILTER_CC_H
#define INCLUDED_ADAPT_S_FO_LMS_FILTER_CC_H
...
/*!
 * \brief Spline-Interpolated and Frequency Offsets-Compensated Least Mean Squares
 * Adaptive filter (complex in/out)
 * \ingroup adapt
 *
 */
class ADAPT_API s_fo_lms_filter_cc : virtual public gr::block
{
protected:
...
public:
    typedef std::shared_ptr<s_fo_lms_filter_cc> sptr;
...
#endif /* INCLUDED_ADAPT_S_FO_LMS_FILTER_CC_H */
