...
#ifndef INCLUDED_ADAPT_RLS_FILTER_FF_H
#define INCLUDED_ADAPT_RLS_FILTER_FF_H
...
/*!
 * \brief Recursive Least Squares Adaptive Filter (float in/out)
 * \ingroup adapt
 *
 * \details
 * This block implements a RLS-based adaptive filter.
 */
class ADAPT_API rls_filter_ff : virtual public gr::sync_decimator {
    public:
    typedef std::shared_ptr<rls_filter_ff> sptr;
...
#endif /* INCLUDED_ADAPT_RLS_FILTER_FF_H */
